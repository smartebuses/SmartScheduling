...
if (WIN32)
    foreach (dir ${CPLEX_DIR})
        file(GLOB CPLEX_LIB_SUFFIXS "${dir}/lib/*windows_*")
        list(SORT CPLEX_LIB_SUFFIXS)
        list(REVERSE CPLEX_LIB_SUFFIXS)
        message(STATUS "CPLEX_LIB_SUFFIXS")
        message(STATUS "${dir}/lib/*windows_sv*")
...
message(STATUS "HATE ${CMAKE_THREAD_LIBS_INIT}")
if (CPLEX_FOUND AND NOT TARGET cplex-library)
    ...
    message(STATUS "KUNT ${CPLEX_INCLUDE_DIR}")
